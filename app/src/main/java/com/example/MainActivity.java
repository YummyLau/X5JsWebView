...
import com.effective.android.x5js.X5JsWebView;
import com.effective.android.x5js.X5WebUtils;
import com.effective.android.x5js.bridge.BridgeHandler;
import com.effective.android.x5js.bridge.CallBackFunction;
import com.effective.android.x5js.bridge.DefaultHandler;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        boolean result = X5WebUtils.hookKeyCode(mWebView, keyCode);
        if (!result) {
