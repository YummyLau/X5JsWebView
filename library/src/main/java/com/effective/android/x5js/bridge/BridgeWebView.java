...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge {
    ...
    private void init() {
        ...
        setWebViewClient(generateBridgeWebViewClient(), false);
    }
    ...
    public void setWebViewClient(WebViewClient webViewClient) {
        setWebViewClient(webViewClient, true);
    }

    private void setWebViewClient(WebViewClient webViewClient, boolean proxy) {
        if (proxy) {
